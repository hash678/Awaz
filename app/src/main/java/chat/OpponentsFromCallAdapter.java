...
public class OpponentsFromCallAdapter extends RecyclerView.Adapter<OpponentsFromCallAdapter.ViewHolder> {
    ...
    public OpponentsFromCallAdapter(Context context, QBRTCSession session, ArrayList<Integer> users, int width, int height) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        //final int user = opponents.get(position);
